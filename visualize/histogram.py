...
if __name__ == "__main__":
    ...
    plt.xticks(rotation=15)  # Rotate x-labels
    plt.tick_params(axis='both', which='major', labelsize=8)  # Reduce font size of x and y ticks
    plt.xlabel("Feature")
    ...
    most_homogeneous_feature = histogram.loc[histogram["Std"].idxmin()]["Feature"]

    plt.figure(figsize=(20, 10))
    sn.histplot(data=entire_dataset, x=most_homogeneous_feature, hue="Hogwarts House")
